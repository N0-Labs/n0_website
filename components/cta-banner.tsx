    ...
    <div className="bg-background-secondary rounded-xl p-9 flex items-center justify-between gap-8 mb-14">
      <div>
        ...
        <p className="text-sm text-text-secondary leading-relaxed max-w-2xl">
          Our team works directly with autonomy engineers. If you're building perception for a UAS, USV, or UGV program, we'll walk you through how Null Labs fits into your stack — no slide deck required.
        </p>
      </div>
